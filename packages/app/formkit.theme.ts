 ...
 *
 * @checksum - 6b53ae9bfb0735590b9cfc1251618017033757ff28b93ca3fee0cceb7f48a300
...
export function rootClasses(
    ...
    const semanticKey = `fk-${sectionName}`;
...
const classes: Record<string, Record<string, boolean>> = {
    ...
    "family:button__input": {
        ...
        "focus:ring-2 ring-primary": true,
        "focus:border-opacity-0": true,
        "dark:text-neutral-100": true,
        "ring-1": true,
        "dark:group-data-[type=button]:text-neutral-100": true,
        "dark:group-data-[type=button]:ring-primary": true,
        "group-data-[type=button]:bg-primary/10": true,
        "hover:group-data-[type=button]:bg-primary/20": true,
        "group-data-[type=button]:text-primary": true,
        "group-data-[type=submit]:ring-primary": true,
        "group-data-[type=submit]:bg-primary": true,
        "hover:group-data-[type=submit]:bg-primary/90": true,
        "group-data-[type=submit]:text-neutral-100": true,
        "font-semibold": true,
    },
    ...
    "family:box__decorator": {
        ...
        "peer-checked:bg-primary/5": true,
        "peer-focus:ring-primary": true,

        "dark:peer-checked:border-neutral-100/5": true,
        "dark:peer-checked:text-neutral-100": true,
        "dark:peer-checked:bg-primary": true,
        "dark:peer-focus:ring-neutral-100": true,
    ...
    "family:text__inner": {
        ...
        flex: true,
        "items-center": true,
        "focus-within:ring-2 ring-primary focus-within:border-opacity-0": true,
        "group-data-[disabled]:!cursor-not-allowed": true,
        "group-data-[invalid]:ring-2": true,
        "group-data-[invalid]:ring-danger": true,
        "focus-within:group-data-[invalid]:ring-primary": true,
        "group-data-[invalid]:border-opacity-0": true,
        "dark:border-neutral-100": true,
    },
    "family:text__input": {
        "appearance-none": true,
    ...
    "family:dropdown__tagWrapper": {
        ...
        "mb-1": true,
        "outline-none": true,
        "data-[active-selection=true]:ring-2 ring-primary": true,
    },
    ...
    "family:dropdown__listbox": {
        ...
        "group-data-[overscroll]:border-neutral-500": true,
    ...
    date__input: {
        "appearance-none": true,
        "[color-scheme:light] dark:[color-scheme:dark]": true,
        "outline-none": true,
        "placeholder:text-neutral-400": true,
        "dark:placeholder:text-neutral-500": true,
        "focus:[&::-webkit-datetime-edit-year-field]:bg-primary": true,
        "focus:[&::-webkit-datetime-edit-year-field]:text-neutral-100": true,
        "focus:[&::-webkit-datetime-edit-month-field]:bg-primary": true,
        "focus:[&::-webkit-datetime-edit-month-field]:text-neutral-100": true,
        "focus:[&::-webkit-datetime-edit-day-field]:bg-primary": true,
        "focus:[&::-webkit-datetime-edit-day-field]:text-neutral-100": true,
    },
    date__message: {
        "text-red-600": true,
        "mb-1.5": true,
    ...
    "datetime-local__input": {
        ...
        "focus:[&::-webkit-datetime-edit-hour-field]:text-neutral-100": true,
        "focus:[&::-webkit-datetime-edit-minute-field]:bg-primary": true,
        "focus:[&::-webkit-datetime-edit-minute-field]:text-neutral-100": true,
        "focus:[&::-webkit-datetime-edit-ampm-field]:bg-primary": true,
        "focus:[&::-webkit-datetime-edit-ampm-field]:text-neutral-100": true,
    },
    ...
    range__input: {
        "appearance-none": true,
        "outline-none": true,
        "placeholder:text-primary": true,
        "dark:placeholder:text-neutral-500": true,
        "[&::-webkit-slider-runnable-track]:bg-primary/10": true,
        "[&::-webkit-slider-runnable-track]:h-1.5": true,
        "[&::-webkit-slider-runnable-track]:rounded-none": true,
        "dark:[&::-webkit-slider-runnable-track]:bg-neutral-100/10": true,
        "[&::-moz-range-track]:bg-primary/10": true,
        "[&::-moz-range-track]:h-1.5": true,
        "[&::-moz-range-track]:rounded-none": true,
        "dark:[&::-moz-range-track]:bg-neutral-100/10": true,
        "[&::-webkit-slider-thumb]:appearance-none": true,
        "[&::-webkit-slider-thumb]:w-5": true,
        "[&::-webkit-slider-thumb]:h-5": true,
        ...
        "[&::-webkit-slider-thumb]:focus-visible:ring-2 ring-primary": true,
        "dark:[&::-webkit-slider-thumb]:bg-primary": true,
        "[&::-moz-range-thumb]:appearance-none": true,
        "[&::-moz-range-thumb]:border-none": true,
        "[&::-moz-range-thumb]:w-5": true,
        "[&::-moz-range-thumb]:h-5": true,
        "[&::-moz-range-thumb]:bg-neutral-600": true,
        "[&::-moz-range-thumb]:rounded-full": true,
        "[&::-moz-range-thumb]:focus-visible:ring-2 ring-primary": true,
    ...
    select__input: {
        ...
        "group-data-[prefix-icon]:!pl-0": true,
        "group-data-[suffix-icon]:!pr-0": true,
        "data-[placeholder]:text-neutral-700": true,
        "dark:text-neutral-100": true,
    ...
    week__input: {
        ...
        "focus:[&::-webkit-datetime-edit-week-field]:text-neutral-100": true,
        "focus:[&::-webkit-datetime-edit-year-field]:bg-primary": true,
        "focus:[&::-webkit-datetime-edit-year-field]:text-neutral-100": true,
    },
    week__message: {
    ...
    autocomplete__selectionWrapper: {
        ...
        "group-data-[multiple]:border-neutral-500": true,
    ...
    colorpicker__control: {
        ...
        "focus-visible:ring-2 ring-primary": true,
        "dark:bg-neutral-900": true,
    ...
    colorpicker__fieldGroup: {
        ...
        "[&>input:focus]:ring-2 ring-primary": true,
    ...
    colorpicker__swatch: {
        ...
        "[&>canvas:focus-visible]:ring-2 ring-primary": true,
    },
    colorpicker__help: {
        "text-neutral-700": true,
        "text-sm": true,
    ...
    datepicker__calendarIcon: {
        "text-neutral-600": true,
        "focus-visible:text-neutral-700": true,
        flex: true,
        "w-[1em]": true,
        "grow-0": true,
        "shrink-0": true,
    ...
    toggle__track: {
        ...
        "transition-all": true,
        "bg-neutral-400": true,
        "peer-focus-visible:ring-2 ring-primary": true,
    ...
    transferlist__outer: {
        ...
        "dark:[&_.dnd-placeholder]:text-neutral-700": true,
    },
    ...
    "multi-step__tabs": {
        ...
        "group-data-[tab-style=tab]/wrapper:border-neutral-500": true,
    ...
    "multi-step__tab": {
        ...
        "dark:group-data-[tab-style=progress]/wrapper:after:bg-neutral-700":
            true,
